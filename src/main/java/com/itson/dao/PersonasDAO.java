...
//                = Persistence.createEntityManagerFactory("org.itson.agenciafiscal");
        try {
            ...
            Persona persona7 = new Persona("ESPJ760514H5", "Juan Carlos", "Esquer", "Pacheco", new GregorianCalendar(1999, 8, 19), new Telefono("6023322661"));
            Persona persona8 = new Persona("ESAM990819M9", "Mariana", "Esquer", "Andrade", new GregorianCalendar(2003, 11, 29), new Telefono("6442040238"));
            Persona persona9 = new Persona("ESCJ361229J8", "José David", "Esquer", "Castro", new GregorianCalendar(1936, 12, 29), new Telefono("6474264278"));
            Persona persona10 = new Persona("SOAA470903B5", "Alonso", "Soto", "Ayala", new GregorianCalendar(1947, 9, 3), new Telefono("6471261845"));
            Persona persona11 = new Persona("SAQJ030314H8", "Jorge Luis", "Sanchez", "Quezada", new GregorianCalendar(2003, 3, 14), new Telefono("6441171436"));
            Persona persona12 = new Persona("MAGM020226D3", "Misael", "Márquez", "Gaxiola", new GregorianCalendar(2002, 2, 26), new Telefono("6442590977"));
            Persona persona13 = new Persona("LOLM030525E2", "Marcos Anselmo", "López", "Lugardo", new GregorianCalendar(2003, 5, 25), new Telefono("3324253380"));
            Persona persona14 = new Persona("GAMG020813G4", "Gael", "Gaxiola", "Maldonado", new GregorianCalendar(2002, 8, 13), new Telefono("6441953838"));
            Persona persona15 = new Persona("PEAR030224A7", "Rosalía", "Pérez", "Acuña", new GregorianCalendar(2003, 2, 24), new Telefono("6442331575"));
            Persona persona16 = new Persona("LUSF020730F3", "Fernando ", "Luque", "Steward", new GregorianCalendar(2002, 7, 30), new Telefono("6442463614"));
            Persona persona17 = new Persona("PEIM020810J1", "Marlon", "Pereo", "Iriqui", new GregorianCalendar(2002, 8, 10), new Telefono("6442490437"));
            Persona persona18 = new Persona("DUPJ020921R3", "Jose Roberto", "Duran", "Padilla", new GregorianCalendar(2002, 9, 21), new Telefono("6441182216"));
            Persona persona19 = new Persona("ROPI030901D4", "Ingrid", "Rosas", "Palacios", new GregorianCalendar(2003, 9, 1), new Telefono("2291748899"));
            Persona persona20 = new Persona("NAHA031007H8", "Adriana Guadalupe", "Naal", "Huchin", new GregorianCalendar(2003, 10, 7), new Telefono("9961018583"));
